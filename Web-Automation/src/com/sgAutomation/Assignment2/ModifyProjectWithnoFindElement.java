...
public class ModifyProjectWithnoFindElement {
	...
	private static void CreateProject()
	{
		...
		try 
		{
			...
			Thread.sleep(3000);
			oPage.getmodifyprojectDesc().clear();
			Thread.sleep(3000);
			oPage.getmodifyprojectDesc().sendKeys("Remodified ProjectNAme into POSSIIBLE IT");
			Thread.sleep(3000);
			oPage.getProjectSectimeCloicon().click();
			Thread.sleep(5000);
