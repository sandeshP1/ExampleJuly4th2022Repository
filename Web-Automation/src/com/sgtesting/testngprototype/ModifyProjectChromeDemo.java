...
//	}
	...
	private static void navigate()
	{
		...
		@Test(priority = 6,dataProvider = "modifiespro")
		private static void modifyProject(String RmP)
		{
			try
			{
				...
				Thread.sleep(3000);
				oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/div/div[1]/textarea")).sendKeys(RmP);
				Thread.sleep(3000);
		...
		@DataProvider
		public Object[][] modifiespro()
		{
			return new Object[][] {
				{"REMODIFIED PROJECT DESCRIPTION"}
			};
		}
